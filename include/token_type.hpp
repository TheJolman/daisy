...
template <> struct std::formatter<TokenType> {
  ...
  auto format(TokenType t, std::format_context &ctx) const {
    ...
    case TokenType::kNull:
      name = "Null";
      break;
    case TokenType::kInt32T:
      name = "Int32T";
      break;
    case TokenType::kInt64T:
      name = "Int64T";
      break;
    case TokenType::kFloat32T:
      name = "Float32T";
      break;
    case TokenType::kFloat64T:
      name = "Float64T";
      break;
    case TokenType::kBoolT:
      name = "BoolT";
      break;
    case TokenType::kCharT:
      name = "CharT";
      break;
    case TokenType::kStringT:
      name = "StringT";
      break;
    case TokenType::kAnyT:
      name = "AnyT";
      break;
    case TokenType::kEOF:
      name = "EOF";
